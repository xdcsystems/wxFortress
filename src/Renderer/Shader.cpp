...
void Shader::compile( const char* vertexSource, const char* fragmentSource, const char* geometrySource )
{
    ...
    GL_CHECK( glShaderSource( sVertex, 1, &vertexSource, NULL ) );
    ...
    GL_CHECK( glShaderSource( sFragment, 1, &fragmentSource, NULL ) );
    ...
    if ( geometrySource != nullptr )
    {
        ...
        GL_CHECK( glShaderSource( gShader, 1, &geometrySource, NULL ) );
