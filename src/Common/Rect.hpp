...
class Rect
{
    public:
        ...
        */
        ...
        inline void left( float n )
        {
            m_width += m_x - n;
            m_x = n;
        }
        inline void moveLeftTo( float n )
        {
            m_x = n;
        }
        ...
        inline void top( float n )
        {
            m_height += m_y - n;
            m_y = n;
        }
        inline void moveTopTo( float n )
        {
            m_y = n;
        }
        ...
        inline void bottom( float n )
        {
            m_height += n - ( m_y + m_height );
        }
        inline void moveBottomTo( float n )
        {
            m_y = n - m_height;
        }
        ...
        inline void right( float n )
        {
            m_width += n - ( m_x + m_width );
        }
        inline void moveRightTo( float n )
        {
            m_x = n - m_width;
        }

        inline glm::vec2 leftTop() const
        {
            return { m_x, m_y };
        }
        ...
        {
            m_x += pt.x - ( m_x + m_width / 2 );
            m_y += pt.y - ( m_y + m_height / 2 );
        }
        ...
        {
            m_x *= ( (float)num ) / ( (float)denum );
            m_y *= ( (float)num ) / ( (float)denum );
            m_width *= ( (float)num ) / ( (float)denum );
            m_height *= ( (float)num ) / ( (float)denum );
        }
